...
let scr_fix_block = document.querySelectorAll('._side-wrapper');// добавить этот класс оболочке сайдбара (она во всю высоту страницы)
...
//-----------------скролл сайдбара с прокруткой страницы-------------------------
...
function fix_block(scr_fix_block, scr_value) {
	...
	for (let index = 0; index < scr_fix_block.length; index++) {
		...
		const item = block.querySelector('._side-block');// добавить этот класс контенту в оболочке сайдбара
